...
const PlayerTab = (props) => {
  ...
  const changePlayStatus = () => {
    console.log("修改播放状态");
    statusDispatch({type:"CHANGECURSTATUS"});
  }
  ...
  return <div className='playerTab'>
    ...
    <ProgressBar  onPlaying={onPlaying} changeCurSong={changeCurSong} duration={curSong.duration} curSongIndex={listState.curSongIndex} getPlayTime={getCurrentTime}/>
