...
const PlayerTab = (props) => {
  ...
  return <div className='playerTab'>
    <audio ref={musicPlayer} autoPlay={onPlaying} src={`https://music.163.com/song/media/outer/url?id=${state.songsList[state.curSongIndex].id}.mp3`} />
