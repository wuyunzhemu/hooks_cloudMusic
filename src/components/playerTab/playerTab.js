...
const PlayerTab = (props) => {
  ...
  const {state,dispatch:listDispatch} = useContext(playList.playListContext);
  ...
  return <div className='playerTab'>
    ...
    <ProgressBar  onPlaying={onPlaying} changeCurSong={changeCurSong} duration={curSong.duration} curSongIndex={state.curSongIndex} getPlayTime={getCurrentTime}/>
